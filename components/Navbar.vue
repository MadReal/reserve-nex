...
nav.grow.h-16.border-b.border-grey-100.py-4.px-6.flex.justify-between
    .flex.items-center
        .relative
            input.w-96.text-sm.rounded-lg-md.p-3.placeholder_text-grey-100.focus_outline-none.focus_text-black(name='search', class='bg-[#F6F6FB]', placeholder='Cerca prenotazione', autocomplete='off')        
