...
.min-h-screen.basis-60(class="bg-[#F1F2F7]")
    ...
    .py-6.px-4
        ...
        .my-8
            ...
            NuxtLink.router-link.flex.items-center.p-4.cursor-pointer.group(to="/admin/block-days")
            ...
            NuxtLink.router-link.flex.items-center.p-4.cursor-pointer.group(to="/admin/block-time")
                SVGIcon.text-grey-100.mr-2.group-hover_text-grey-200(svg="block", :size="20")
