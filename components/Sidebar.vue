...
.min-h-screen.basis-60(class="bg-[#F1F2F7]")
    ...
    .py-6.px-4
        .mb-8.mt-4
            ...
            NuxtLink.router-link.flex.items-center.p-4.cursor-pointer.group(to="/admin/prenotazioni" class="")
                SVGIcon.text-grey-100.mr-2.group-hover_text-grey-200(svg="check", :size="20")
                p.text-sm.text-grey-200.tracking-wide Prenotazioni
            NuxtLink.router-link.flex.items-center.p-4.cursor-pointer.group(to="/admin/riepilogo-giorno")
            ...
            NuxtLink.router-link.flex.items-center.p-4.cursor-pointer.group(to="/admin/gestione-orari")
        ...
        .my-8
            ...
            NuxtLink.router-link.flex.items-center.p-4.cursor-pointer.group(to="/admin/blocco-giorni")
            ...
            NuxtLink.router-link.flex.items-center.p-4.cursor-pointer.group(to="/admin/blocco-orari")
                SVGIcon.text-grey-100.mr-2.group-hover_text-grey-200(svg="block", :size="20")
