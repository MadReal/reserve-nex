...
div(v-if="activeModal !== null")
	.flex.items-center.justify-center.absolute.inset-0.z-20(class="bg-white/80")
		.relative(class="w-5/12").h-80.bg-white.rounded-lg.border.border-slate-100.py-12.px-8.shadow-lg.shadow-gray-100
