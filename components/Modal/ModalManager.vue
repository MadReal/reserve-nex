...
div(v-if="activeModal !== null")
	.flex.items-center.justify-center.absolute.inset-0.z-20(class="bg-black/80")
		.relative(class="w-10/12 lg_w-4/12 lg_min-w-[36rem]", v-on-click-outside="storeModals.closeModal").bg-white.rounded-lg.border.border-slate-100.p-12.pb-16
			...
			ModalReservation(v-else-if="activeModal === 'reservation'")
</template>