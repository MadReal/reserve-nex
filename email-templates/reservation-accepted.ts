      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td class="bg_white logo" style="padding: 0.5em 2.5em; text-align: center">
            <h1><a href="#">${body.restaurant.name}</a></h1>
				...
				<tr>
          <td valign="middle" class="hero" style="background-image: url(https://www.investireoggi.it/news/wp-content/uploads/sites/12/2021/11/Nuovi-ristoranti-dItalia-ecco-la-top-ten-secondo-gli-esperti-di-The-Fork.jpeg); background-size: cover; height: 140px;">
            <table>
            	<tr>
            		<td>
		        ...
		        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
		          <tr>
                    ...
                    <p>Gentile ${body.personName},<br> 
                      Abbiamo il piacere di confermare la prenotazione del suo tavolo il giorno <strong>${
                        body.date
                      }</strong> alle ore <strong>${body.time}</strong> per ${
                        body.peopleAmount
                      } person${
                        body.peopleAmount > 1 ? "e" : "a"
                      }, come da lei richiesto.</p>
                    ...
                    }, ${body.restaurant.city} ${body.restaurant.zipCode}</p>
		            	</div>
		            </td>
		          </tr><!-- end: tr -->
		        </table>
