            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
              <tr>
                ...
                <td class="text email-section" style="text-align: left;">
                  ...
                  <p>
                    Siamo spiacenti, la tua prenotazione del <strong>${body.date}</strong> alle ore
                    <strong>${body.time}</strong> è stata annullata. Presto la
                    contatteremo per organizzare una nuova prenotazione.
                    In alternativa, può visitare il nostro sito per
